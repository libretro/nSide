...
struct ManagedNode : nall::Markup::ManagedNode {
protected:
  ...
  friend auto unserialize(const string&) -> nall::Markup::SharedNode;
};

inline auto unserialize(const string& markup) -> nall::Markup::SharedNode {

...
auto CheatEditor::refreshLocale() -> void {
  ...
  cheatList.header().column(1).setText(locale["Tools/CheatEditor/Table/Slot"]);
  cheatList.header().column(2).setText(locale["Tools/CheatEditor/Table/Codes"]);
  cheatList.header().column(3).setText(locale["Tools/CheatEditor/Table/Description"]);
...
//Because nSide shares the same cheat code format, use "higan" instead of "nSide"
